...
function VSCodeCard() {
    ...
    try {
        if (act.details != "Idling" && typeof act.application_id !== 'undefined' && act.application_id != null && typeof act.state !== 'undefined') {
            ...
            return (
                <div id="vscodeCard" className="focus:outline-none transition duration-300 ease-in-out transform hover:scale-105 p-3 rounded-md border border-gray-800 dark:border-gray-400 shadow flex flex-row max-w-sm">
                    <img
                        height={45}
                        width={45}
